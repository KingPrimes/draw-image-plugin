...
public class Fonts {
    ...
    public static Font createFont(String fontPath, int fontFormat, int style, int size) {
        ...
        return FONT_CACHE.computeIfAbsent(key, k -> loadFont(fontPath, fontFormat, style, size));
    }

    private static Font loadFont(String fontPath, int fontFormat, int style, int size) {
